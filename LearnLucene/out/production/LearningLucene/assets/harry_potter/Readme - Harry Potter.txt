...
This Researcher Format dataset is a set of .csv (comma separated value) files containing metadata for resources relating to Harry Potter from the British National Bibliography (BNB) and our British Library collections. It was initially released to coincide with the 20th anniversary of the publication of 'Harry Potter and the Philosopher's Stone' on 26th June 2017, and has been updated annually thereafter.
